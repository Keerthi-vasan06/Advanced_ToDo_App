  ...
  const fetchTasksAndReminders = async () => {
    try {
      ...
      for (const task of fetchedTasks) {
        ...
        setReminders(remindersWithTask);
...
const handleDeleteReminder = async (reminderId) => {
  ...
  if (!editingReminderId) {
    alert("No reminder selected for editing.");
    return;
  }
  ...
  try {
    await apiUpdateReminder(editingReminderId, updatedReminder);
    await fetchRemindersForTask(editReminderTaskId);
    setEditingReminderId(null);
    setEditReminderTaskId("");
    setEditReminderDate("");
